...
import os
import sys
from ..config import PUBLIC_DIR, SETTINGS_FILE, get_config
from .colors import color_text
Config = get_config()
SETTINGS_FILE = SETTINGS_FILE  # Keep for compatibility

# Use translations directory directly (PUBLIC_DIR is already set to translations/)
LANG_DIR = PUBLIC_DIR
DEFAULT_LANG = "en"
