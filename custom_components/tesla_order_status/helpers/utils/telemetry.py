...
from ..config import TELEMETRIC_URL, VERSION, get_config
from .helpers import pseudonymize_data
from .params import DETAILS_MODE, SHARE_MODE, STATUS_MODE, CACHED_MODE, ALL_KEYS_MODE
from .connection import request_with_retry
from .locale import t, LANGUAGE, get_os_locale
Config = get_config()
...
def track_usage(orders: List[dict]) -> None:
    ...
    from .orders import get_model_from_order
